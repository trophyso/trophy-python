...
class TrophyApi:
    ...
    environment : TrophyApiEnvironment
        ...
        Defaults to TrophyApiEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: TrophyApiEnvironment = TrophyApiEnvironment.DEFAULT,
        api_key: str,
...
def _get_base_url(
    *, base_url: typing.Optional[str] = None, environment: TrophyApiEnvironment
) -> str:
